...
export const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate(
                `/verify?email=${encodeURIComponent(email)}&type=register`,
                {
                    state: {
                        successMessage:
            ...
            <Box
                ...
                <Box sx={{ textAlign: 'center', position: 'relative' }}>
                    ...
                    <Typography
                        ...
                        Join thousands of businessess managing their finances
                        with ease
                    </Typography>
                    ...
                    <Box
                        ...
                        <Box sx={bulletContainerSx}>
                            ...
                            <Box sx={bulletBoxSx}>
                                ...
                                <Typography sx={bulletBoxInfoSx}>
                                    Get started in minutes and connect your
                ...
                <Grid
                    ...
                    <Box component="form" onSubmit={handleSubmit}>
                        ...
                        <Typography sx={{ color: 'text.secondary', mb: 3 }}>
                            Sign up to start managing your finances with
                            SmartPay
                        </Typography>
                        {errorMessage && (
